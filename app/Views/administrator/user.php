...
<html lang="en">
    ...
    <body data-background-color="bg3">
											...
											<table class="table table-striped table-hover" id="table1" style="width:100%">
												<thead>
													<tr>
														...
														<th><div class="pr-3">Email</div></th>
														<th><div class="pr-3">Pengguna</div></th>
														<th><div class="pr-3">Grup</div></th>
														<th><div class="pr-3">Aktif</div></th>
														<th><div class="pr-3">Dibuat</div></th>
														<th><div class="pr-3">Diubah</div></th>
        ...
        <script>
			$('#add').click(function(){
				window.location.assign('userAdd')
			});
            ...
            var oTable = $("#table1").dataTable({
				...
				"columnDefs": [
					{ "name": "a.id", "targets": 0 },
					{ "name": "a.fullname", "targets": 1 },
					{ "name": "a.email", "targets": 2 },
					{ "name": "a.username", "targets": 3 },
					{ "name": "groups", "targets": 4 },
					{ "name": "a.active", "targets": 5, "orderable": false },
					{ "name": "a.created_at", "targets": 6 },
					{ "name": "a.updated_at", "targets": 7 },
