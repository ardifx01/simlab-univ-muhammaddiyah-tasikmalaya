...
<html lang="en">
    ...
    <body data-background-color="bg3">
											...
											<table class="table table-striped table-hover" id="table1" style="width:100%">
												<thead>
													<tr>
														...
														<th><div class="pr-3">URL</div></th>
														<th><div class="pr-3">Parent</div></th>
														<th><div class="pr-3">Urutan</div></th>
														<th><div class="pr-3">Ikon</div></th>
        ...
        <script>
			$('#add').click(function(){
				window.location.assign('menuAdd')
			});
            ...
            var oTable = $("#table1").dataTable({
				...
				"columnDefs": [
					...
					{ "name": "a.parent_id", "targets": 2 },
					{ "name": "a.href", "targets": 3 },
					{ "name": "a.order_number", "targets": 4 },
					{ "name": "a.icon", "targets": 5 },
					{ "name": "a.active", "targets": 6, "orderable": false },
