											...
											<div class="row">
												<div class="col-sm-8">
													...
													<div class="form-group row">
														<div class="col-sm-3">
															<label class="font-weight-bold">Nama Grup</label>
														</div>
														<div class="col-sm-9 <?php if (session('errors.name')) : ?>has-error<?php endif ?>">
															<input type="text" class="form-control <?php if (session('errors.name')) : ?>needsfilled<?php endif ?>"
																name="nama" id="nama" placeholder="Nama Grup" value="<?php echo $groupRow->name;?>">
														</div>
													</div>
													...
													<div class="form-group row">
														...
														<div class="col-sm-9">
															<input type="text" class="form-control" name="description" id="description" placeholder="Deskripsi" value="<?php echo $groupRow->description; ?>">
														</div>
													</div>
													
												</div>
												<div class="col-sm-4 pl-4 pr-4">
													<p class="font-weight-bold">Jenis Izin</p>
