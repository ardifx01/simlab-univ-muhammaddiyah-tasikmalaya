									...
									<div class="card">
										...
										<div class="card-body">
											...
											<div class="form-group row">
												<div class="col-sm-3">
													<label class="font-weight-bold">Nama Jenis Izin</label>
												</div>
												<div class="col-sm-9 <?php if (session('errors.name')) : ?>has-error<?php endif ?>">
													...
													name="name"id="name" placeholder="Nama Jenis Izin"value="<?php echo $permissionRow->name;?>">
												</div>
											</div>
											...
											<div class="form-group row">
												...
												<div class="col-sm-9">
													<input type="text" class="form-control" name="description" id="description" placeholder="Deskripsi" value="<?php echo $permissionRow->description; ?>">
												</div>		
											</div>
										</div>
									</div>
