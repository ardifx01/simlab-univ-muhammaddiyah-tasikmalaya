											...
											<div class="row">
												<div class="col-sm-8">
													...
													<div class="form-group row">
														...
														<div class="col-sm-9">
															<input type="text" class="form-control" name="name" id="name" placeholder="Nama Menu" value="<?php echo $menuRow->name;?>">
														</div>
													</div>
													...
													<div class="form-group row">
														...
														<div class="col-sm-9">
															<input type="text" class="form-control" name="href" id="href" placeholder="URL" value="<?php echo $menuRow->href; ?>">
														</div>
													</div>
													...
													<div class="form-group row">
														...
														<div class="col-sm-9">
															<select class="form-control" name="parent_id" id="parent_id">
																...
																<option value="<?php echo $mP->id; ?>" <?php echo ($mP->id == $menuRow->parent_id ? 'selected' : ''); ?>>
																	<?php echo $mP->name; ?>
													...
													<div class="form-group row">
														...
														<div class="col-sm-9">
															<input type="text" class="form-control" name="icon" id="icon" placeholder="Ikon" value="<?php echo $menuRow->icon; ?>">
														</div>
													</div>
													...
													<div class="form-group row">
														...
														<div class="col-sm-9">
															<input type="number" class="form-control" name="order_number" id="order_number" placeholder="Urutan" value="<?php echo $menuRow->order_number; ?>">
														</div>
													</div>
													...
													<div class="form-group row">
														...
														<div class="col-sm-9">
															<select class="form-control" name="active" id="active">
																<option value="1" <?php echo ($menuRow->active == 1 ? 'selected' : ''); ?>>Aktif</option>
																<option value="0" <?php echo ($menuRow->active == 0 ? 'selected' : ''); ?>>Tidak aktif</option>
															</select>
														</div>
													</div>
												...
												<div class="col-sm-4 pl-4 pr-4">
													...
													<input type="checkbox" id="<?php echo $pL->name; ?>" name="<?php echo $pL->name; ?>" value="<?php echo $pL->id; ?>" <?php echo $pL->checked; ?>>
