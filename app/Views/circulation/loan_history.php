    ...
    <body data-background-color="bg3">
													...
													<table class="table table-striped table-hover" id="tabel-peminjaman-mhs" style="width:100%">
														<thead>
															<tr>
																...
																<th><div class="pr-3">Tgl Pengembalian</div></th>
        ...
        <script>
			...
			var oTable = $("#tabel-peminjaman-mhs").dataTable({
				"search": {
					"search": "<?php echo $searchRiwayatPeminjamanMhs; ?>"
				},
				"columnDefs": [
					...
					{ "name": "a.tgl_kembali", "targets": 5, "data": 6 },
					{ "targets": 6, "data": 7, "orderable": false }
				],
				"pagingType": "numbers",
				"searching": true,
				"ordering": false,
				"iDisplayStart": <?php echo ((isset($startRiwayatPeminjamanMhs) && $startRiwayatPeminjamanMhs != '') ? $startRiwayatPeminjamanMhs : 0)?>,
				"iDisplayLength" : <?php echo ((isset($lengthRiwayatPeminjamanMhs) && $lengthRiwayatPeminjamanMhs != '') ? $lengthRiwayatPeminjamanMhs : 10)?>,
				"bFilter" : false,							 
				"bLengthChange": true,
				"processing": true,
				"serverSide": true,
			...
			var oTable2 = $("#tabel-peminjaman-dosen").dataTable({
				"search": {
					"search": "<?php echo $searchRiwayatPeminjamanDosen; ?>"
				},
				"columnDefs": [
					{ "name": "", "targets": 0, "orderable": false },
					...
					{ "name": "a.tgl_kembali", "targets": 4, "data": 5 },
					{ "targets": 5, "data": 6, "orderable": false }
				],
				"pagingType": "numbers",
				"searching": true,
				"ordering": false,
				"iDisplayStart": <?php echo ((isset($startRiwayatPeminjamanDosen) && $startRiwayatPeminjamanDosen != '') ? $startRiwayatPeminjamanDosen : 0)?>,
				"iDisplayLength" : <?php echo ((isset($lengthRiwayatPeminjamanDosen) && $lengthRiwayatPeminjamanDosen != '') ? $lengthRiwayatPeminjamanDosen : 10)?>,
				"bFilter" : false,							 
				"bLengthChange": true,
				"processing": true,
				"serverSide": true,
