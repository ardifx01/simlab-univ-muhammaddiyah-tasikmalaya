    ...
    <body data-background-color="bg3">
											...
											<table class="table table-striped table-hover" id="table1" style="width:100%">
												<thead>
													<tr>
														...
														<th><div class="pr-3">Angkatan</div></th>
													</tr>
												</thead>
												<tbody></tbody>
											</table>
        ...
        <script>
			$('#add').click(function(){
				...
				.then((willSync) => {
					if (willSync) {
						window.location.assign('/masterdata/studentsSync')
					}
				});
			});
            ...
            var oTable = $("#table1").dataTable({
				...
				"columnDefs": [
					...
					{ "name": "a.name", "targets": 2},
					{ "name": "a.major", "targets": 3},
					{ "name": "a.yoe", "targets": 4}
				],
				"pagingType": "numbers",
				"searching": true,
				"ordering": true,
