											...
											<div class="row">
												<div class="col-sm-12">
													...
													<div class="form-group row">
														<div class="col-sm-3"><label class="font-weight-bold">Nama Lab</label></div>
														<div class="col-sm-9">
															<input type="text" class="form-control" name="nama" id="nama" placeholder="Nama Lab"
															value="<?php echo $labRow->nama?>">
														</div>
													</div>
													...
													<div class="form-group row">
														...
														<div class="col-sm-9">
															...
															value="<?php echo $labRow->deskripsi?>">
														</div>
													</div>
													
													<div class="form-group row">
														<div class="col-sm-3"><label class="font-weight-bold">Lantai Awal</label></div>
														<div class="col-sm-9">
															<input type="number" min="1" max="200" step="1" class="form-control" name="lantai_awal" id="lantai_awal"
															placeholder="Lantai Awal" value="<?php echo $labRow->lantai_awal?>">
														</div>
													</div>
													
													<div class="form-group row">
														<div class="col-sm-3"><label class="font-weight-bold">Jumlah Lantai</label></div>
														<div class="col-sm-9">
															<input type="number" min="1" max="200" step="1" class="form-control" name="jml_lantai" id="jml_lantai"
															placeholder="Jumlah Lantai" value="<?php echo $labRow->jml_lantai?>">
														</div>
													</div>
