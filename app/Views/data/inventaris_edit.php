												...
												<div class="col-sm-12">
													...
													<div class="form-group row">
														...
														<div class="col-sm-9">
															...
															foreach ($labs as $row)
															{
																echo '<option value="'.$row->id.'" '.($row->id == $inventarisRow->id_lab ? 'selected' : '').'>'.$row->nama.'</option>';
															}
															?>
															</select>
														</div>
													...
													<div class="form-group row">
														<div class="col-sm-3"><label class="font-weight-bold">Nama Inventaris</label></div>
														<div class="col-sm-9">
															<input type="text" class="form-control" name="nama" id="nama" placeholder="Nama Inventaris"
															value="<?php echo $inventarisRow->nama?>">
														</div>
													</div>
													...
													<div class="form-group row">
														...
														<div class="col-sm-9">
															...
															value="<?php echo $inventarisRow->deskripsi?>">
														</div>
													</div>
													...
													<div class="form-group row">
														...
														<div class="col-sm-9">
															...
															value="<?php echo $inventarisRow->code_prefix?>">
														</div>
													</div>
													...
													<div class="form-group row">
														...
														<div class="col-sm-9">
															...
															value="<?php echo $inventarisRow->code_suffix?>">
														</div>
													</div>
													...
													<div class="form-group row">
														...
														<div class="col-sm-9">
															...
															placeholder="Panjang Kode" value="<?php echo $inventarisRow->code_length?>">
														</div>
													</div>
