											...
											<div class="row">
												<div class="col-sm-12">
													...
													<div class="form-group row">
														...
														<div class="col-sm-9"><?php echo $item->nama; ?></div>
													</div>
													
													<div class="form-group row">
														<div class="col-sm-3"><label class="font-weight-bold">Kode</label></div>
														<div class="col-sm-9"><?php echo $item->kode; ?></div>
													</div>
													
													<div class="form-group row">
														<div class="col-sm-3"><label class="font-weight-bold">Keterangan</label></div>
														<div class="col-sm-9">
															<textarea class="form-control" name="keterangan" id="keterangan"><?php echo $item->keterangan?></textarea>
														</div>
													</div>
