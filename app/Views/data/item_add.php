...
<html lang="en">
    ...
    <body data-background-color="bg3">
											...
											<div class="row">
												<div class="col-sm-12">
													...
													<div class="form-group row">
														<div class="col-sm-3"><label class="font-weight-bold">Inventaris</label></div>
														<div class="col-sm-9">
													...
													<div class="form-group row" id="form_jml_item">
														<div class="col-sm-3"><label class="font-weight-bold">Jumlah Item</label></div>
														<div class="col-sm-9">
															<input type="number" class="form-control" name="jml_item" id="jml_item" placeholder="Jumlah item yang akan ditambahkan"
															disabled>
														</div>
													</div>
        ...
        <script>
			...
			required = ["id_inventaris", "jml_item"];
			errornotice = $("#error");
			emptyerror = "";
